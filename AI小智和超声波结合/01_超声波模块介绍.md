...
### 详情可以看<a href="../resource/WS2812B.PDF" target="_blank">WS2812B规格书</a>
...
<a href="AI小智和超声波结合/resource/RGBUltrasonicModule.zip" download>点击下载</a>

### Mixly

![rus_04_mixly](picture/rus_04_mixly.png)

<a href="./resource/rus_04_mixly.zip" download>点击下载Mixly程序</a>

### ESP8266/ESP32示例程序

<a href="./resource/ESP32_RGBUltrasonicModule.zip" download>点击下载</a>

### MicroPython示例程序

<a href="./resource/rgb_ultrasonic_esp32_micropython.zip" download>点击下载ESP32 MicroPython示例程序</a>
