...
<a href="./resource/temperature_humidity_sensor_schematic.pdf" target="_blank">点击此处查看原理图</a>
...
<a href="./resource/DHT11.doc" download>点击此处查看规格书</a>

## Arduino示例程序

<a href="./resource/temperature_humidity_sensor.zip" download>下载示例程序</a>
...
接入AI-VOX3 **扩展板**的 3 号引脚，将在日志中打印温湿度传感器的值。
